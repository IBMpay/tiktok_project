...
export const useMarket = () => {
  ...
  // useEffect(() => {
  //   const init = async () => {
  //     const anchorWallet = await useTorWallet(torusWallet);
  //     console.log("the wallet adapter: ", anchorWallet);
  //     setAnchorWallet(anchorWallet);
  //   };
  //   init();
  // }, [connection, torusWallet]);
  // const anchorWallet: any = useTorWaller(provider);
  const program = useMemo(() => {
    // const anchorWallet: any = useTorWallet(provider);
    if (anchorWallet) {
